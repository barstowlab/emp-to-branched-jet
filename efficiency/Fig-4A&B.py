...
# Code to recreate figures 4A and 4B in "Efficiency Estimates for Electromicrobial Production of 
...
scenarioTableFileName = 'input/Fig-4A&B.csv'
outputFilenameFuelMassEff = join(outputDir, 'Fig-4A.csv')
outputFilenameEff = join(outputDir, 'Fig-4B.csv')
...
# Plot the energy consumption per unit mass (Fig. 4A)
...
# Plot the energy conversion efficiency (Fig. 4B)
